...
[Run]
Filename: "{app}\bbapi.exe"; WorkingDir: "{app}"; Flags: nowait runhidden runascurrentuser; StatusMsg: Finishing installation. Please wait, this might take a few minutes...
